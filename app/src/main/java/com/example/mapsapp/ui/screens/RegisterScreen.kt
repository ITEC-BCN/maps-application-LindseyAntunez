...
fun RegisterScreen(navigateToHome: () -> Unit) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        AndroidView(factory = { context ->
            MapView(context).apply {
                ...
                getMapAsync { googleMap ->
                    ...
                    googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(LatLng(- 40.8436, -1.8876
                    ), 1f))
                }
            }
        ...
        Column(
            ...
            Text(
                text = "Explora el mundo con nosotros!!",
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(24.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
                    ...
                    Button(
                        onClick = { viewModel.signUp(); navigateToHome() },
                        modifier = Modifier.fillMaxWidth(),
                        colors = ButtonDefaults.buttonColors(Color(0xFF2E8B57)) // Verde mapa
                    ) {
                        Text("Registrarse", modifier = Modifier.padding(start = 8.dp), color = Color.White)
                    }
                }
            }
